...
public class HostInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, String uid, Integer hstid)
        ...
        try {
            ...
            out.println(Monitoring.HostInfo(uid,hstid));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        processRequest(request, response, uid, Integer.parseInt( request.getParameter("hstid") ));
    }
