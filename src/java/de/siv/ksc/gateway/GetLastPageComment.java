 ...
 * @author sbaresel
 */
public class GetLastPageComment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, String uid)
        ...
        try {
            ...
            out.println(Functions.GetLastPageComment(uid));
            
        } catch (FileNotFoundException ex) {
            Logger.getLogger(GetLastPageComment.class.getName()).log(Level.SEVERE, null, ex);
