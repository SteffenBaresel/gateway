 ...
 * @author sbaresel
 */
public class GetSingleContractType extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, String cttyid)
        ...
        try {
            ...
            out.println(Functions.GetSingleContractType(cttyid));
            
        } catch (FileNotFoundException ex) {
            Logger.getLogger(GetSingleContractType.class.getName()).log(Level.SEVERE, null, ex);
