 ...
 * @author sbaresel
 */
public class GetLastPageContactsComment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, String uid)
        ...
        try {
            ...
            out.println(Functions.GetLastPageContactsComment(uid));
            
        } catch (FileNotFoundException ex) {
            Logger.getLogger(GetLastPageContactsComment.class.getName()).log(Level.SEVERE, null, ex);
