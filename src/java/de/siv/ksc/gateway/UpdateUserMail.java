 ...
 * @author sbaresel
 */
public class UpdateUserMail extends HttpServlet {
    
    Properties props = null;
    
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, String uid, String mail)
        ...
        try {
            Functions.UpdateUserMail( uid, mail);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        processRequest(request, response, uid, request.getParameter("mail"));
    }
