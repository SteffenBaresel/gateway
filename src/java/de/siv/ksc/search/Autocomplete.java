...
public class Autocomplete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, String uid, String type, String val)
        ...
        try {
            ...
            out.println(Search.Autocomplete(uid,type,val));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        processRequest(request, response, uid, request.getParameter("t"), request.getParameter("v") );
    }
